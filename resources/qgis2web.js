...
map.getView().fit([-573620.186032, 4404198.451369, -573186.205977, 4404522.485441], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">QFIELD_RONDA (QFieldCloud)</h2>';
        return titleElement;
    })(),
